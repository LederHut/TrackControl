...
public class Grid extends JPanel implements MouseWheelListener ,MouseListener
{
	...
	public Grid (int rows, int cols, int cellWidth)
	{
		...
		orignalImages = new ImageIcon[images][4];
		loadRailImages();
		scaledImages = new ImageIcon[images][4];
		scaleRailImages();
	...
	private void loadRailImages()
	{
		...
		//
		//Variation two
		//orignalImages[2][0] = new ImageIcon("src/Images/Brokenrail_diagon_1.png");
		//orignalImages[2][1] = new ImageIcon("src/Images/Brokenrail_diagon_2.png");
		//orignalImages[2][2] = new ImageIcon("src/Images/Brokenrail_diagon_3.png");
		//orignalImages[2][3] = new ImageIcon("src/Images/Brokenrail_diagon_4.png");
		//
		//Variation three
		//orignalImages[2][0] = new ImageIcon("src/Images/Brokenrail_diagon_1.png");
		//orignalImages[2][1] = new ImageIcon("src/Images/Brokenrail_diagon_2.png");
		...
		for(int col = 0; col < myLabels.length; col++){
			for(int row = 0; row < myLabels.length; row++){
				if(label == myLabels[row][col])
				{
					...
					{
						label.setIcon(scaledImages[rand_int(selected, selected + 3)]
				  	  			                  [selectedOrientation]);
					}
					else
					{
